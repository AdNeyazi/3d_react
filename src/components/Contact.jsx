...
const Contact = () => {
  ...
  //       {
  //         from_name: form.name,
  //         to_name: "Adnan Neyazi",
  //         from_email: form.email,
  //         to_email: "adnanneyazi88@gmail.com",
      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a href="mailto:adnanneyazi88@gmail.com" target="_blank" className="blue-text-gradient">adnanneyazi88@gmail.com</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
            <a href="https://api.whatsapp.com/send/?phone=918956603774&text&app_absent=0&lang=en" target="_blank" className="blue-text-gradient">
              8956603774
            </a>
          </article>
        </div>
