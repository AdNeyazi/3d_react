  ...
  useEffect(() => {
    ...
    if (textRef.current) {
      init(textRef.current, {
        showCursor: true,
        strings: [ 'Mentor ', 'Software Developer ', 'ROR Developer ', ' Tech Enthusiast '],
      });
  ...
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        ...
        <div className="head2">
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hii there, I'm <p className='name text-[#915EFF]'>Adnan Neyazi</p>
          </h1>
          <h3>
        ...
        <a
          href="https://github.com/AdNeyazi" target="_blank">
          <AiOutlineGithub />
        </a>
        <a
          href="#" target="_blank">
      ...
      <div className="imgcontainer1 absolute violet-gradient">
        <img src={aarti} alt="profile" className="object-contain"/>
      </div>
      </div>
